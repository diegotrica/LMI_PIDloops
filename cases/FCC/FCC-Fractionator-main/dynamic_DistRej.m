function [R1,R2,R3,R4,R5,R6,R7,R8,R9,R10,SPfcc,Temperature,Vapor,Comp1,Comp2,Comp3,Comp4,Comp5,Comp6,Comp7,Comp8,Comp9,Comp10,Liquid,Holdup,EnthalL,EnthalV,Ttrack,SPfrac,ProductsMB,LPG,MVfrac,ufra,xfra,xc,products,errord,xfil,Valvesfrac,time]=dynamic_DistRej()
%***********************************************************************************************************************************************************************************************************************************************************
