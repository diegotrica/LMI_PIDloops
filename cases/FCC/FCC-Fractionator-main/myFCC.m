function [delta,yp]=myFCC(xfcc,dist,ufcc,Flpg,Tcondenser,cont)
%************************************************************************************************************************************************************************
...
%alpha=(100/160)
eTC3=(SPRGT-Treg)*1;
        %YALMIP_Sprcd    %LMILAB_ILMI     %LMILAB_Qfd     %YALMIP_Qfd     %YALMIP_DropQf      %Santander
KcTC3=  2.3618;         %2.3296;         %2.3296;        %2.4555;        %2.3307;            %1.5;
TaoTC3= 640;            %640;            %640;           %640;           %640;               %800;
p6nom=50;
...
ePC1=(SPRG-P6)*-1;     
        %YALMIP_Sprcd   %LMILAB_ILMI    %LMILAB_Qfd      %YALMIP_Qfd        %YALMIP_DropQf     %Santander
KcPC1=  1951.6;         %1766;           %2505.3;         %914.9;            %760.4;            %1500;                             
TaoPC1= 160;            %160.6603;       %160;            %159.756;          %160.2474;         %200;                              
V7nom=50;
...
%alpha=1, hence, p(t)=valve(t)
eLC1=(SPCI-Wr)*-1;
        %YALMIP_Sprcd   %LMILAB_ILMI    %LMILAB_Qfd      %YALMIP_Qfd     %YALMI_DropQf       %Santander
KcLC1=  1.2998e-4;      %1.5501e-4;      %1.5531e-4;      %1.7070e-4;     %1.5545e-4;         %1e-4;
TaoLC1= 800;            %800.0104;       %800;            %800;           %800;               %1000;
V3nom=50;
...
eTC1=(SPPH-T2)*1;
        %YALMIP_Sprcd   %LMILAB_ILMI    %LMILAB_Qfd     %YALMIP_Qfd     %YALMIP_DropQf      %Santander
KcTC1=  7.8978;         %7.7670;         %7.7653;        %7.7608;        %7.7652;            %5;
TaoTC1= 80.0000;        %79.9997;        %80;            %80;            %80;                %100;
p1nom=50;
...
eTC2=(SPRT-Tr)*1;
        %YALMIP_Sprcd   %LMILAB_ILMI    %LMILAB_Qfd     %YALMIP_Qfd     %YALMIP_DropQf      %Santander
KcTC2=  0.6499;         %0.7450;         %0.7765;        %0.7928;        %0.7643;            %0.5;                       
TaoTC2= 160;            %160.2041;       %160;           %160;           %160;               %200;  
V2nom=50;
