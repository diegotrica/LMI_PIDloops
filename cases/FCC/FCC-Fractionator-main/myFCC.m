...
%alpha=(100/160)
eTC3=(SPRGT-Treg)*1;
        %NLP           %YALMIP_Sprcd    %LMILAB_ILMI   %Santander
KcTC3=  1.0000;        2.3618;         %2.3296;        %1.5;
TaoTC3= 99.9998;       640;            %640;           %800;
p6nom=50;
...
ePC1=(SPRG-P6)*-1;     
        %NLP           %YALMIP_Sprcd   %LMILAB_ILMI    %Santander
KcPC1=  6.9526e3;      1951.6;         %1766;          %1500;                             
TaoPC1= 34.7795;       160;            %160.6603;      %200;                              
V7nom=50;
...
eLC1=(SPCI-Wr)*-1;
        %NLP           %YALMIP_Sprcd   %LMILAB_ILMI    %Santander
KcLC1=  2.9996e-4;     1.2998e-4;      %1.5501e-4;     %1e-4;
TaoLC1= 399.9564;      800;            %800.0104;      %1000;
V3nom=50;
...
eTC1=(SPPH-T2)*1;
        %NLP           %YALMIP_Sprcd   %LMILAB_ILMI    %Santander
KcTC1=  0.7584;        7.8978;         %7.7670;        %5;
TaoTC1= 25.2876;       80.0000;        %79.9997;       %100;
p1nom=50;
...
eTC2=(SPRT-Tr)*1;
        %NLP           %YALMIP_Sprcd   %LMILAB_ILMI    %Santander
KcTC2=  1.9999;        0.6499;         %0.7450;        %0.5;                       
TaoTC2= 500.1342;      160;            %160.2041;      %200;  
V2nom=50;
