...
clear, close all
load('cases\FCC\nominal\FCC_Frac_DistRej_nom.mat');
nom.out1=R7;                                                                                                                                                                                                                     
outss=SPfcc;
nom.out2=R10;
nom.out3=R6;
...
nom.out7=Valvesfrac;
save('cases\FCC\results\data\FCC_Frac_DistRej_comp.mat','nom','outss','out2ss','time');

%Nominal results from LMI tuning (This Work)
clear
load('cases\FCC\results\data\FCC_Frac_DistRej_lmi.mat');
tw.out1=R7;                                                                                                                                                                                                                     
tw.out2=R10;
tw.out3=R6;
tw.out4=R9;
...
tw.out7=Valvesfrac;
save('cases\FCC\results\data\FCC_Frac_DistRej_comp.mat','tw','-append');

%Nominal results from iterative LMI tuning (ILMI)
clear
load('cases\FCC\results\data\FCC_Frac_DistRej_ilmi.mat');
ilmi.out1=R7;                                                                                                                                                                                                                     
ilmi.out2=R10;
ilmi.out3=R6;
ilmi.out4=R9;
...
save('cases\FCC\results\data\FCC_Frac_DistRej_comp.mat','ilmi','-append');

clear
load('cases\FCC\results\data\FCC_Frac_DistRej_comp.mat');
