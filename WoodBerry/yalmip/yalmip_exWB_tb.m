...
myfile{1,1}='cases\WoodBerry\yalmip\results\data\yalmip_exWB_SOFS_L2N_NOTITER_Nd=5_Nl=1_PhiD=60_gL2=1000.mat';
myfile{1,2}='cases\WoodBerry\yalmip\results\data\yalmip_exWB_SOFS_L2N_ILMI_Nd=5_Nl=1_PhiD=60_gL2=1000.mat';

myfile{2,1}='cases\WoodBerry\yalmip\results\data\yalmip_exWB_SOFS_L2N_NOTITER_Nd=5_Nl=1_PhiD=60_gL2=100.mat';
myfile{2,2}='cases\WoodBerry\yalmip\results\data\yalmip_exWB_SOFS_L2N_ILMI_Nd=5_Nl=1_PhiD=60_gL2=100.mat';

myfile{3,1}='cases\WoodBerry\yalmip\results\data\yalmip_exWB_SOFS_L2N_NOTITER_Nd=5_Nl=1_PhiD=60_gL2=10.mat';
myfile{3,2}='cases\WoodBerry\yalmip\results\data\yalmip_exWB_SOFS_L2N_ILMI_Nd=5_Nl=1_PhiD=60_gL2=10.mat';

tstart=0; tend=300; tstep=0.1; t=(tstart:tstep:tend)'; %time domain
yf=[0.1;0.1]; dw=0.245;

Nrlt=0;
save('cases\WoodBerry\yalmip\results\data\yalmip_exWB_tb_rlt.mat');
...
%----- ILMI technique PID control -----------------------------------------
    ...
    Nrlt=Nrlt+1;
    save('cases\WoodBerry\yalmip\results\data\yalmip_exWB_tb_rlt.mat','rlt','-append');
    load('cases\WoodBerry\yalmip\results\data\yalmip_exWB_tb_rlt.mat','myfile');
end
...
tab1
save('cases\WoodBerry\yalmip\results\data\yalmip_exWB_tb_rlt.mat','tab1','-append');
%--------------------------------------------------------------------------
% ----- Table 2 -----------------------------------------------------------
tab2=table(...
...
tab2
save('cases\WoodBerry\yalmip\results\data\yalmip_exWB_tb_rlt.mat','tab2','-append');
%--------------------------------------------------------------------------
% ----- Table 3 -----------------------------------------------------------
tab3=table(...
...
tab3
save('cases\WoodBerry\yalmip\results\data\yalmip_exWB_tb_rlt.mat','tab3','-append');
%--------------------------------------------------------------------------
% ----- Table 3 -----------------------------------------------------------
tab4=table(...
...
tab4
save('cases\WoodBerry\yalmip\results\data\yalmip_exWB_tb_rlt.mat','tab4','-append');
