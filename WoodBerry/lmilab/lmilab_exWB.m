...
% myfile=strjoin({'cases\WoodBerry\lmilab\lmilab_exWB_SOFS_L2N_NOTITER_Nd=',num2str(Nsd),'_Nl=',num2str(Poly.Nl),'_PhiD=',num2str(nthroot(det(PhiD),Ny)),'_gL2=',num2str(gL2)},'');
% myfile=strjoin({'cases\WoodBerry\lmilab\lmilab_exWB_SOFS_L2N_ILMI_Nd=',num2str(Nsd),'_Nl=',num2str(Poly.Nl),'_PhiD=',num2str(nthroot(det(PhiD),Ny)),'_gL2=',num2str(gL2)},'');
% diary(myfile);
%--------------------------------------------------------------------
