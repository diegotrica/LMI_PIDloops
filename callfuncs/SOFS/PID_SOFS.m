...
switch law
    case 'P'
LMISYS=LMI_P(Poly,sK_,KPlb,KPub);
    
	case 'PI'
LMISYS=LMI_PI(Poly,sK_,KPlb,KPub,TIlb,TIub);

    case 'PID'
LMISYS=LMI_PID(Poly,sK_,PhiD,KPlb,KPub,TIlb,TIub,TDlb,TDub);
end 
...
function LMISYS=LMI_P(Poly,sK_,KPlb,KPub)
%Parameters
Nx=Poly.Nx; 	%State variables size
Ny=Poly.Ny;		%Output variables size
Nl=Poly.Nl;		%Number of polytope LTI system verteces
...
function LMISYS=LMI_PI(Poly,sK_,KPlb,KPub,TIlb,TIub)
%Parameters
Nx=Poly.Nx; 	%State variables size
Ny=Poly.Ny;		%Output variables size
Nl=Poly.Nl;		%Number of polytope LTI system verteces
...
function LMISYS=...
	LMI_PID(Poly,sK_,PhiD,KPlb,KPub,TIlb,TIub,TDlb,TDub)
%Parameters
Nx=Poly.Nx; 	%State variables size
Ny=Poly.Ny;		%Output variables size
Nl=Poly.Nl;		%Number of polytope LTI system verteces
